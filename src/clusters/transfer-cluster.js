  ...
  await handleTransaction('Sending transaction...', [
      ...
      transaction(address: Address) {
          ...
          prepare(acct: AuthAccount) {
              ...
              self.transferToken <- collectionRef.withdraw(withdrawID: 39) // set "withdrawID" as a variable
              self.getMetadataRef = collectionRef.getMetadata(id: 39) // set "id" as a variable
          }
