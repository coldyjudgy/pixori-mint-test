  ...
  await handleTransaction('Sending transaction...', [
      ...
      transaction(address: Address) {
          ...
          prepare(acct: AuthAccount) {
              ...
              self.transferToken <- collectionRef.withdraw(withdrawID: 45) // set "withdrawID" as a variable
              self.getMetadataRef = collectionRef.getMetadata(id: 45) // set "id" as a variable
          }
